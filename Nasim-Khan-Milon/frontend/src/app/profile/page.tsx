...
const ProfilePage = () => {
    ...
    const { user, isAuth, loading, setUser, fetchChats } = useAppData();
    ...
    const submitHandler = async (e: any) => {
        ...
        try {
            const { data } = await axios.put(`${user_service}/api/user/update`, { name }, { headers: { Authorization: `Bearer ${token}` } });
        ...
        <div className="min-h-screen bg-gray-900 p-4">
            <div className="max-w-2xl mx-auto pt-8">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className='text-3xl font-bold text-white'>Profile Setting</h1>
                                    ...
                                    isEdit ? <form onSubmit={submitHandler} className="space-y-4">
                                        <div className="relative">
                                            <input
                                                ...
                                                className="w-full px-4 py-3 bg-gray-700 border  text-white placeholder-gray-400"
                                            />
                                        ...
                                        <button onClick={editHandler} className="flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg">
                                            Edit
                                        </button>
                                    </div>
                                }
