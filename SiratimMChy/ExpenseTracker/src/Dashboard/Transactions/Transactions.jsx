    ...
    return (
        <div className="min-h-screen bg-base-100 px-3 py-6 sm:px-6 lg:px-10">
                    ...
                    {filtered.length === 0 ? (
                        ...
                        <>
                            ...
                            <div className="hidden md:block overflow-x-auto">
                                <div className="grid grid-cols-[2rem_2fr_1fr_1fr_7rem_5rem] gap-x-4 px-4 pb-2 text-[10px] uppercase tracking-widest text-base-content/30 font-bold">
                                    <span>#</span>
                                    <span>Details</span>
                                    <span>Category</span>
                                    <span>Date</span>
                                ...
                                <div className="space-y-1.5">
                                    {filtered.map((t, i) => (
                                        <div
                                            key={t._id}
                                            className="grid grid-cols-[2rem_2fr_1fr_1fr_7rem_5rem] gap-x-4 items-center bg-base-100 hover:bg-base-300/40 border border-base-content/5 hover:border-base-content/10 rounded-xl px-4 py-3 transition-all duration-150"
                                        >
                                            ...
                                            <div className="flex justify-center gap-1.5">
                                                <button
                                                    ...
                                                    className="p-1.5 text-base-content/30 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
                                                    title="Edit"
                                                >
                                                    <Pencil size={14} />
                                                </button>
                            ...
                            <div className="md:hidden space-y-2">
                                {filtered.map((t) => (
                                    <div key={t._id} className="flex items-center gap-2.5 bg-base-100 border border-base-content/5 rounded-xl px-3 py-3">
                                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${t.type === 'income' ? 'bg-green-100' : 'bg-red-100'}`}>
                                            {t.type === 'income'
                                                ? <TrendingUp size={14} className="text-green-600" />
                                                : <TrendingDown size={14} className="text-red-500" />
                                        ...
                                        <div className="text-right shrink-0">
                                            ...
                                            <div className="flex justify-end gap-1 mt-1">
                                                <button
                                                    onClick={() => handleEditOpen(t)}
                                                    className="p-1 text-base-content/30 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors"
                                                >
                                                    <Pencil size={12} />
                                                </button>
                                                <button
                                                    onClick={() => handleDelete(t._id)}
                                                    disabled={deletingId === t._id}
                                                    className="p-1 text-base-content/30 hover:text-red-500 hover:bg-red-50 rounded-md transition-colors disabled:opacity-40"
                                                >
                                                    {deletingId === t._id
                                                        ? <span className="loading loading-spinner loading-xs"></span>
                                                        : <Trash2 size={12} />
            ...
            <dialog id="edit_modal" className="modal modal-bottom sm:modal-middle">
                <div className="modal-box bg-base-100 border border-base-content/10 p-6 sm:p-8">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-lg font-bold text-base-content">Edit Transaction</h3>
                        <button
                    ...
                    {editingTx && (
                        <div className="space-y-4">
                            {/* Type */}
                            <div>
                                <p className="text-sm font-semibold text-base-content mb-2">Type</p>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className="text-sm font-semibold text-base-content block mb-1.5">Amount</label>
                                    <input
                                        name="amount"
                                        type="number"
                                        step="0.01"
                                        ...
                                        className="input input-bordered bg-base-100 w-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                                    />
                                </div>
                                <div>
                                    <label className="text-sm font-semibold text-base-content block mb-1.5">Date</label>
                                    <input
                                        name="date"
                                        type="date"
                            ...
                            {/* Category */}
                            <div>
                                <label className="text-sm font-semibold text-base-content block mb-1.5">Category</label>
                                <select
                                    name="category"
                                    value={editingTx.category}
                                    onChange={handleEditChange}
                                    className="select select-bordered bg-base-100 w-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                                >
                            ...
                            {/* Description */}
                            <div>
                                <label className="text-sm font-semibold text-base-content block mb-1.5">Description</label>
                                <textarea
                                    name="description"
                                    ...
                                    className="textarea textarea-bordered bg-base-100 w-full resize-none focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                                />
                            </div>
                            ...
                            <div className="flex gap-3 pt-2">
                                ...
                                <button
                                    ...
                                    disabled={saving}
                                    className="btn bg-gradient-to-r from-blue-600 to-cyan-600 text-white border-none flex-1"
                                >
                                    {saving
