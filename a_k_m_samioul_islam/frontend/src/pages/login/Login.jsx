  ...
  return (
    <div className="w-full max-w-full flex inter">
      ...
      <div className="w-full max-w-full lg:max-w-[50%] min-h-screen flex flex-col items-center justify-center p-10">
        ...
        <div className="w-full max-w-125 flex items-center gap-2 text-sm mb-5">
          <div className="w-full bg-gray-400 h-px"></div>
          <p className="w-full text-gray-400 font-medium text-[8px] md:text-[12px] text-center">
            OR LOGIN WITH EMAIL
          </p>
          <div className="w-full bg-gray-400 h-px"></div>
        </div>

        <form className="w-full max-w-125 mb-10">
