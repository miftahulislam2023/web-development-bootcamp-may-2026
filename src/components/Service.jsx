...
import { services } from "../pages/ServicesDetails/serviceData";
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <span style={{ color: t.accent }}> For Everyday Life</span>
          </h1>
          ...
          >
            Manage your personal finances effortlessly with Spendora. Track
            expenses, analyze spending patterns, and achieve your financial
            goals with modern tools built for smarter money management.
          </p>
        </motion.div>

        <div className="mt-16 sm:mt-20 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8">
          {services.map((service, index) => {
            const IconComponent = service.icon; // ← component reference থেকে JSX বানাও
            return (
              <motion.div
                key={service.id}
