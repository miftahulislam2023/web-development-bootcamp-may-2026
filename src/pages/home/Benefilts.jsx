      ...
      <section className="w-full pt-20 pb-10 px-4">
        <div className="max-w-5xl mx-auto text-center" ref={hero.ref}>
          ...
          >
            ...
            >
              Spendora combines AI intelligence, beautiful design, and
              rock-solid security into one app that actually changes your
              financial habits.
            </motion.p>
          </motion.div>
        </div>
      ...
      <section className="w-full py-10 px-4">
        <div className="max-w-5xl mx-auto" ref={cards.ref}>
          <motion.div
            variants={stagger}
            initial="hidden"
            animate={cards.inView ? "show" : "hidden"}
      ...
      <section className="w-full py-10 px-4" ref={mini.ref}>
        <div className="max-w-5xl mx-auto">
          <motion.div
            variants={stagger}
            initial="hidden"
            animate={mini.inView ? "show" : "hidden"}
      ...
      <section className="w-full py-14 px-4">
        <div className="max-w-3xl mx-auto" ref={compare.ref}>
          <motion.div
            variants={fadeUp}
            initial="hidden"
            animate={compare.inView ? "show" : "hidden"}
          ...
          >
            ...
            {COMPARE_ROWS.map((row, i) => (
              <motion.div
                ...
                animate={
                  compare.inView ? { opacity: 1, x: 0 } : { opacity: 0, x: -20 }
                }
      ...
      <section className="w-full py-16 px-4" ref={banner.ref}>
        <div className="max-w-4xl mx-auto">
          <motion.div
            variants={scaleIn}
            initial="hidden"
            animate={banner.inView ? "show" : "hidden"}
          ...
          >
            ...
            <div className="flex-1 text-center md:text-left flex flex-col gap-3">
              ...
              <p
                ...
                style={{ color: t.textSub }}
              >
                Join 20 million people already using Spendora. Free to start —
