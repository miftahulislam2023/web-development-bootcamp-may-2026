...
const LINKS = {
  Product: [
    { label: "Features",    href: "features",       type: "route, scroll" },
    { label: "Services",     href: "services",        type: "route, scroll" },
    { label: "Dashboard",   href: "dashboardLayout",   type: "route, scroll"  },
    { label: "Payments",   href: "payments",       type: "route, scroll" },
    { label: "About us",     href: "about",         type: "route, scroll" },
  ],
  Company: [
...
const SOCIALS = [
  ...
  {
    label: "LinkedIn",
    href:  "https://www.linkedin.com/in/mahiya-rehman/",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: "Instagram",
    href:  "https://www.instagram.com/mahiya_mimu/",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
